<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $sql = "SELECT student_id, sex, last_name, suffix, contact, street, city, province, postal, country,    created_at FROM parents WHERE 
            ...
            <table>
                ...
                <?php 
                    ...
                    foreach($data as $entry):
                        $fullName = $entry['last_name']." ".$entry['suffix'];
